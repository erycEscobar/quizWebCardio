import './CompleteLosCasilleros.scss';
...
import Icon from '../../../../assets/02-Practicas/02-03-completar.png';
import ExercisesNavigation from '../../components/ExercisesNavigation/ExercisesNavigation';


const CompleteLosCasilleros = () => {
            ...
            <ExerciseContextProvider>
                ...
                <section className='mainView_container'>
                    <div className='headerContent_container'>
                        <SelectedFilters />
                        <TitleSection icon={Icon} title='COMPLETE LOS CASILLEROS' />
...
export default CompleteLosCasilleros